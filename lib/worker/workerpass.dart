...
class WPass extends StatefulWidget {
  const WPass({super.key});

  @override
  State<WPass> createState() => _PassState();
}

class _PassState extends State<WPass> {
  @override
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              const WorkerLog()), // Define Succadreg
                    );
                  },
                  child: const Center(
                    child: Text(
